<%@ Page Language="C#" MasterPageFile="~/Master/MainMaster.master" AutoEventWireup="true" CodeBehind="Inq_Bank.aspx.cs" Inherits="Ers_Pro.Int_Inquiries.Bank.Inq_Bank" %>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <table class="table">
                            <tr>
                                <td class="label">نام بانک / موسسه :
                                </td>
                                <td class="lable">
                                    <asp:TextBox ID="Txt_BankName" AutoCompleteType="Disabled" runat="server" CssClass="normal_TextBox"></asp:TextBox>
                                </td>
